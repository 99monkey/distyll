...
1. Add a +distyll:+ database to your database.yml
1. Run +rake db:create RAILS_ENV=distyll+
1. Run +rake db:schema:load RAILS_ENV=distyll+
1. Run +rails console+
1. Call +Distyll.new(model_names, created_since)+, passing it an array of strings of the core models and a date after which core records will be copied.
